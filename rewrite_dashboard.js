...
// fix the "bg-gray-900 border border-gray-700 text-gray-200" inputs to use gray-800 instead of 700 if needed, but not explicitly requested except borders.
// Prompt: "Maintain the strict dark theme (#040a18, #0a1224)."
